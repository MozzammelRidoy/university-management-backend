...
const getSingleAcademicFacultyFromDB = (facultyId) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield academicFaculty_model_1.AcademicFaculty.findById(facultyId);
    return result;
});
const updateAcademicFacultyIntoDB = (facultyId, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield academicFaculty_model_1.AcademicFaculty.findOneAndUpdate({ _id: facultyId }, payload, { new: true });
    return result;
});

...
const academic_Semester_service_1 = require("./academic.Semester.service");
const getAllSemester = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield academic_Semester_service_1.AcademicSemesterService.getAllSemesterFromDB();
...
const getSingleSemester = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield academic_Semester_service_1.AcademicSemesterService.getSingleSemesterFromDB(semesterId);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
...
const createAcademicSemester = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield academic_Semester_service_1.AcademicSemesterService.createAcademicSemesterIntoDB(req.body);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
...
const updateAcademicSemester = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { semesterId } = req.params;
    const result = yield academic_Semester_service_1.AcademicSemesterService.updateSingleAcademicSemesterIntoDB(semesterId, req.body);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,

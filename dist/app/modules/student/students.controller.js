...
const getSingleStudent = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const result = yield students_service_1.StudentService.getSingleStudentFromDB(id);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
...
const updateStudent = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield students_service_1.StudentService.updateSingleStudentFromDB(id, student);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
...
const deleteSingleStudent = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const result = yield students_service_1.StudentService.deleteStudentFromDB(id);
